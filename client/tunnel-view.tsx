import { openProjectRepository } from "./web";
import { ConnectionStatus } from "./components/connection-status";
import { routeOfferPreview } from "../shared/route-offer-preview";
import { RequestPanel } from "./components/request-panel";
import type { TunnelState } from "../shared/tunnel-types";
import { PLUGIN_VERSION } from "../shared/version";
import { useTranslation, LanguageProvider } from "./language";
    ...
    >
      ...
      {!dialog && (
        ...
        >
          ...
          <Text
            accessibilityLabel={`Version ${PLUGIN_VERSION}`}
